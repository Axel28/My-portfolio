...
(function () {
  ...
  function init() {
    var onEndInitialAnimation = function onEndInitialAnimation() {
  ...
  function startLoading() {
    ...
    var simulationFn = function simulationFn(instance) {
      var progress = 0,
        ...
        instance.setProgress(progress); // reached the end
        ...
        if (progress === 1) {
          ...
          var onEndHeaderAnimation = function onEndHeaderAnimation(ev) {
            if (support.animations) {
...
$(document).ready(function () {
  $('.link__next').on('click', function () {
    ...
    $('.' + rel).removeClass('close__button--hide'); // do whatever you want to do
  });
...
function progress() {
  ...
  if (screen.width >= 1025) {
    ...
    $('.progress .bar').height(progress + '%').css({
      backgroundColor: $bgColor
    });
  }
}
